...
This module defines the FileStorage class, responsible for serializing instances to a JSON file
and deserializing a JSON file to instances. It provides methods to manage a dictionary (__objects)
